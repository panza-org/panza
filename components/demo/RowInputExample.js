...
import { View, Text, ScrollView, Picker, LayoutAnimation } from "react-native";
    ...
    return (
      <Base flex={1}>
        <ScrollView style={{ flex: 1 }}>
          ...
          <InputHelpText>
            Some help text. Aute nulla ex ea amet sunt occaecat qui fugiat
            cupidatat fugiat in. Veniam amet elit et tempor sit ea nulla
          ...
          <InputGroup label="REMOVABLE INPUT" inset={16} mt={3} mb={3}>
            <RemovableInput

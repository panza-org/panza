...
Navbar.totalNavHeight = _reactNative.Navigator.NavigationBar.Styles.General.TotalNavHeight;
...
var styles = _reactNative.StyleSheet.create({
  hasChildren: {
    height: _reactNative.Navigator.NavigationBar.Styles.General.TotalNavHeight + 80
  },
  children: _extends({
    height: 80
  ...
  navTopRow: {
    flexDirection: 'row',
    flex: 1,
    height: _reactNative.Navigator.NavigationBar.Styles.General.TotalNavHeight,
